...
public class JSONThisParser implements JSONParser{
    ...
    public final JSONArray parseArray(String text) {
        return (JSONArray) parse(text,DEFAULT_PARSER_FEATURE);
    }
    ...
    protected static final String toJSONString(Object object, boolean prettyFormat) {
        if (!prettyFormat) {
            return toJSONString(object,SerializerFeature.UseISO8601DateFormat);
        }
    ...
    protected static final Object toJSONObject(Object javaObject, ParserConfig mapping) {
        ...
        if (javaObject instanceof JSONThisParser) {
            return (JSONThisParser) javaObject;
        }
