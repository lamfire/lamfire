...
public class MurmurHash
{
	...
	public static int hash32(byte[] bytes,int offset, int length,int seed){
		ByteBuffer buffer = ByteBuffer.wrap(bytes);
		return hash32(buffer,offset,length,seed);
	}
	
	public static long hash64(byte[] bytes,int offset, int length,int seed){
		ByteBuffer buffer = ByteBuffer.wrap(bytes);
		return hash64(buffer,offset,length,seed);
	}
	
	public static int hash32(byte[] bytes,int seed){
		ByteBuffer buffer = ByteBuffer.wrap(bytes);
		return hash32(buffer,0,bytes.length,seed);
	}
	
	public static long hash64(byte[] bytes,int seed){
		ByteBuffer buffer = ByteBuffer.wrap(bytes);
		return hash64(buffer,0,bytes.length,seed);
	}
