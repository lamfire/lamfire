...
import com.lamfire.json.util.ClassWriter;
import com.lamfire.json.util.FieldInfo;
import com.lamfire.json.util.JSONField;
import com.lamfire.json.util.Label;
import com.lamfire.json.util.MethodVisitor;
import com.lamfire.json.util.Opcodes;
...
public class ASMSerializerFactory implements Opcodes {
	...
	public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
		...
		cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "java/lang/Object", new String[] { "com/lamfire/json/serializer/ObjectSerializer" });
...

		{
			...
			mw = cw.visitMethod(ACC_PUBLIC, "write", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;)V", null, new String[] { "java/io/IOException" });

			mw.visitVarInsn(ALOAD, context.serializer()); // serializer
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "getWriter", "()" + ASMUtils.getDesc(SerializeWriter.class));
			mw.visitVarInsn(ASTORE, context.var("out"));

			Label _else = new Label();

			mw.visitVarInsn(ALOAD, context.var("out"));
			mw.visitFieldInsn(GETSTATIC, ASMUtils.getType(SerializerFeature.class), "SortField", "L" + ASMUtils.getType(SerializerFeature.class) + ";");
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "isEnabled", "(" + "L" + ASMUtils.getType(SerializerFeature.class) + ";" + ")Z");

			mw.visitJumpInsn(IFEQ, _else);
			mw.visitVarInsn(ALOAD, 0);
			mw.visitVarInsn(ALOAD, 1);
			mw.visitVarInsn(ALOAD, 2);
			mw.visitMethodInsn(INVOKEVIRTUAL, className, "write1", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;)V");
			mw.visitInsn(RETURN);
...

		{
			...
			mw = cw.visitMethod(ACC_PUBLIC, "write1", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;)V", null, new String[] { "java/io/IOException" });
	...
	private void _enum(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
		...
		mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;L" + ASMUtils.getType(Enum.class) + ";)V");
	...
	private void _decimal(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
		...
		mw.visitLabel(_else); // else { out.writeFieldValue(seperator,
		...
		mw.visitVarInsn(ALOAD, context.fieldName());
		mw.visitVarInsn(ALOAD, context.var("decimal"));
		mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;Ljava/math/BigDecimal;)V");
	...
	private void _string(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
		...
		mw.visitVarInsn(ALOAD, context.fieldName());
		mw.visitVarInsn(ALOAD, context.var("string"));
		mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldValue", "(CLjava/lang/String;Ljava/lang/String;)V");
	...
	private void _list(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
...

		{
			...
			mw.visitTypeInsn(CHECKCAST, ASMUtils.getType(ObjectSerializer.class)); // cast
			// to
			// string
			...
			if (elementType == String.class) {
				...
				mw.visitTypeInsn(CHECKCAST, ASMUtils.getType(String.class)); // cast to
				// string
				mw.visitVarInsn(BIPUSH, ',');
				mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeString", "(Ljava/lang/String;C)V");
			} else {
				mw.visitVarInsn(ALOAD, context.serializer());
				mw.visitVarInsn(ALOAD, context.var("list"));
				mw.visitVarInsn(ILOAD, context.var("i"));
				mw.visitMethodInsn(INVOKEINTERFACE, ASMUtils.getType(List.class), "get", "(I)Ljava/lang/Object;");
				mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "write", "(Ljava/lang/Object;)V");
	...
	private void _filters(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
		if (property.getField() != null) {
			if (Modifier.isTransient(property.getField().getModifiers())) {
				mw.visitVarInsn(ALOAD, context.var("out"));
				mw.visitFieldInsn(GETSTATIC, ASMUtils.getType(SerializerFeature.class), "SkipTransientField", "L" + ASMUtils.getType(SerializerFeature.class) + ";");
				mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "isEnabled", "(" + "L" + ASMUtils.getType(SerializerFeature.class) + ";" + ")Z");
	...
	private void _writeObject(MethodVisitor mw, FieldInfo fieldInfo, Context context, Label _end) {
		...
		if (format != null) {
			...
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "writeWithFormat", "(Ljava/lang/Object;Ljava/lang/String;)V");
		} else {
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(JSONSerializer.class), "write", "(Ljava/lang/Object;)V");
		}
	...
	private void _apply(MethodVisitor mw, FieldInfo property, Context context) {
		...
		if (propertyClass == byte.class) {
			mw.visitVarInsn(ILOAD, context.var("byte"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
		} else if (propertyClass == short.class) {
			mw.visitVarInsn(ILOAD, context.var("short"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Z");
		} else if (propertyClass == int.class) {
			mw.visitVarInsn(ILOAD, context.var("int"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Z");
		} else if (propertyClass == char.class) {
			mw.visitVarInsn(ILOAD, context.var("char"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Z");
		} else if (propertyClass == long.class) {
			mw.visitVarInsn(LLOAD, context.var("long"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Z");
		} else if (propertyClass == float.class) {
			mw.visitVarInsn(FLOAD, context.var("float"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Z");
		} else if (propertyClass == double.class) {
			mw.visitVarInsn(DLOAD, context.var("double"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Z");
		} else if (propertyClass == boolean.class) {
			mw.visitVarInsn(ILOAD, context.var("boolean"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply", "(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
		} else if (propertyClass == BigDecimal.class) {
			...
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
		} else if (propertyClass == String.class) {
			mw.visitVarInsn(ALOAD, context.var("string"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "apply",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
	...
	private void _processValue(MethodVisitor mw, FieldInfo property, Context context) {
		...
		mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processValue",
				"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
	...
	private void _processKey(MethodVisitor mw, FieldInfo property, Context context) {
		...
		if (propertyClass == byte.class) {
			...
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Ljava/lang/String;");
		} else if (propertyClass == short.class) {
			mw.visitVarInsn(ILOAD, context.var("short"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Ljava/lang/String;");
		} else if (propertyClass == int.class) {
			mw.visitVarInsn(ILOAD, context.var("int"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;");
		} else if (propertyClass == char.class) {
			mw.visitVarInsn(ILOAD, context.var("char"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Ljava/lang/String;");
		} else if (propertyClass == long.class) {
			mw.visitVarInsn(LLOAD, context.var("long"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Ljava/lang/String;");
		} else if (propertyClass == float.class) {
			mw.visitVarInsn(FLOAD, context.var("float"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Ljava/lang/String;");
		} else if (propertyClass == double.class) {
			mw.visitVarInsn(DLOAD, context.var("double"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Ljava/lang/String;");
		} else if (propertyClass == boolean.class) {
			mw.visitVarInsn(ILOAD, context.var("boolean"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Z)Ljava/lang/String;");
		} else if (propertyClass == BigDecimal.class) {
			mw.visitVarInsn(ALOAD, context.var("decimal"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
		} else if (propertyClass == String.class) {
			mw.visitVarInsn(ALOAD, context.var("string"));
			mw.visitMethodInsn(INVOKESTATIC, ASMUtils.getType(FilterUtils.class), "processKey",
					"(Lcom/lamfire/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
	...
	private void _if_write_null(MethodVisitor mw, FieldInfo fieldInfo, Context context) {
		...
		if (!writeNull) {
			mw.visitVarInsn(ALOAD, context.var("out"));
			mw.visitFieldInsn(GETSTATIC, ASMUtils.getType(SerializerFeature.class), "WriteMapNullValue", "L" + ASMUtils.getType(SerializerFeature.class) + ";");
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "isEnabled", "(" + "L" + ASMUtils.getType(SerializerFeature.class) + ";" + ")Z");
			mw.visitJumpInsn(IFEQ, _else);
		}
		...
		if (propertyClass == String.class || propertyClass == Character.class) {
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullString", "(CLjava/lang/String;)V");
		} else if (Number.class.isAssignableFrom(propertyClass)) {
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullNumber", "(CLjava/lang/String;)V");
		} else if (propertyClass == Boolean.class) {
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullBoolean", "(CLjava/lang/String;)V");
		} else if (Collection.class.isAssignableFrom(propertyClass) || propertyClass.isArray()) {
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNullList", "(CLjava/lang/String;)V");
		} else {
			mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.getType(SerializeWriter.class), "writeFieldNull", "(CLjava/lang/String;)V");
		}
